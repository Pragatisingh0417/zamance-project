    ...
    <header className="sticky top-0 z-50 bg-white shadow-md">
      <nav className="mx-auto max-w-7xl flex items-center justify-between px-4 sm:px-6 py-3 md:py-4">
        ...
        <ul className="hidden lg:flex items-center gap-6 xl:gap-10 text-sm md:text-base font-medium text-black">
          ...
          {/* Desktop Services Dropdown (CSS Hover – FIXED) */}
          <li className="relative group">
            ...
            <div
              className="
                ...
                rounded-xl border border-black/10 bg-white shadow-xl
                opacity-0 invisible
          ...
          <NavLink
            to="/contact"
            className="ml-4 rounded-full bg-[#1E3A8A] px-6 py-2 text-white font-semibold hover:bg-[#1FA45B] transition"
          >
            Get Started
          </NavLink>
                ...
                <ul className="pl-4 space-y-1">
                  {services.map(([label, path]) => (
                    <NavLink
                      ...
                      className="block py-2 px-2 rounded hover:bg-[#1FA45B]/10"
                    >
                      {label}
                    </NavLink>
                  ))}
...
<NavLink
              to="/contact"
              onClick={closeAllMenus}
              className="mt-3 rounded-full bg-[#1E3A8A] px-4 py-2 text-white text-center hover:bg-[#1FA45B]"
            >
              Get Started
            </NavLink>
